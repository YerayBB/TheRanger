...
import theRanger.potions.brown.BottledSoul;
import theRanger.potions.brown.InfusivePotion;
import theRanger.potions.brown.LiquidCourage;
...
public class DefaultMod implements
    ...
    private static final String ATTACK_DEFAULT_GRAY = "theRangerResources/images/512/bg_attack_default_gray.png";
    private static final String SKILL_DEFAULT_GRAY = "theRangerResources/images/512/bg_skill_default_gray.png";
    private static final String POWER_DEFAULT_GRAY = "theRangerResources/images/512/bg_power_default_gray.png";
    
    private static final String ENERGY_ORB_DEFAULT_GRAY = "theRangerResources/images/512/card_default_gray_orb.png";
    private static final String CARD_ENERGY_ORB = "theRangerResources/images/512/card_small_orb.png";
    
    private static final String ATTACK_DEFAULT_GRAY_PORTRAIT = "theRangerResources/images/1024/bg_attack_default_gray.png";
    private static final String SKILL_DEFAULT_GRAY_PORTRAIT = "theRangerResources/images/1024/bg_skill_default_gray.png";
    private static final String POWER_DEFAULT_GRAY_PORTRAIT = "theRangerResources/images/1024/bg_power_default_gray.png";
    private static final String ENERGY_ORB_DEFAULT_GRAY_PORTRAIT = "theRangerResources/images/1024/card_default_gray_orb.png";
    
    // Character assets
    private static final String THE_DEFAULT_BUTTON = "theRangerResources/images/charSelect/DefaultCharacterButton.png";
    private static final String THE_DEFAULT_PORTRAIT = "theRangerResources/images/charSelect/DefaultCharacterPortraitBG.png";
    public static final String THE_DEFAULT_SHOULDER_1 = "theRangerResources/images/char/defaultCharacter/shoulder.png";
    public static final String THE_DEFAULT_SHOULDER_2 = "theRangerResources/images/char/defaultCharacter/shoulder2.png";
    public static final String THE_DEFAULT_CORPSE = "theRangerResources/images/char/defaultCharacter/corpse.png";
    
    //Mod Badge - A small icon that appears in the mod settings menu next to your mod.
    public static final String BADGE_IMAGE = "theRangerResources/images/Badge.png";
    
    // Atlas and JSON files for the Animations
    public static final String THE_DEFAULT_SKELETON_ATLAS = "theRangerResources/images/char/defaultCharacter/skeleton.atlas";
    public static final String THE_DEFAULT_SKELETON_JSON = "theRangerResources/images/char/defaultCharacter/skeleton.json";
    ...
    public DefaultMod() {
      ...
      */
        ...
        logger.info("Creating the color " + TheDefault.Enums.COLOR_BROWN.toString());
        
        BaseMod.addColor(TheDefault.Enums.COLOR_BROWN, DEFAULT_BROWN, DEFAULT_BROWN, DEFAULT_BROWN,
    ...
    public void receiveEditCards() {
        ...
        new AutoAdd("RangerMod") // ${project.artifactId}
