...
public class TenacityPower extends AbstractPower {
    ...
    public static final String POWER_ID = DefaultMod.makeID("TenacityPower");
    ...
    public TenacityPower(final AbstractCreature owner, final AbstractCreature source, final int amount) {
        this.name = NAME;
        this.ID = POWER_ID;
    ...
    public void onUseCard(AbstractCard card, UseCardAction action) {
        if(action.actionType == AbstractGameAction.ActionType.BLOCK && card.block){
